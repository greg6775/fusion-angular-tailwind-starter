...
export const dashboardRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'music',
        loadComponent: () => import('./music/music-dashboard.component').then(m => m.MusicDashboardComponent),
        title: 'Music Dashboard - BBN Music'
      },
      {
        path: 'music/new-drop',
        loadComponent: () => import('./music/new-drop/new-drop.component').then(m => m.NewDropComponent),
