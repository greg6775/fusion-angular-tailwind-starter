...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, ButtonComponent, CardComponent, BadgeComponent, TopNavComponent],
  template: `
    <!-- Navigation -->
    <app-top-nav
      [user]="null"
      ...
      <div class="relative z-10 container-max section-padding text-center">
        <div class="max-w-4xl mx-auto">
          <h1 class="text-5xl sm:text-6xl lg:text-7xl font-black text-white mb-6 leading-tight">
            ...
            <span class="text-gradient bg-gradient-to-r from-primary-400 to-primary-600 bg-clip-text text-transparent">
              Audience
            </span>
          </h1>
      ...
      <div class="container-max">
        ...
        <div class="relative overflow-hidden">
          <div class="flex animate-scroll-left space-x-12">
            <div *ngFor="let platform of [...platformLogos, ...platformLogos]" class="flex-shrink-0">
              <div class="platform-logo w-16 h-16 flex items-center justify-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <app-card variant="pricing" class="relative">
            <div class="text-center">
              ...
              <div class="mb-8">
                <div class="text-6xl font-black text-gray-900 dark:text-gray-100 mb-2">97<span class="text-2xl">%</span></div>
                <div class="text-lg text-gray-600 dark:text-gray-400">Revenue Share</div>
                <div class="text-sm text-gray-500 dark:text-gray-500 mt-1">No Extra Cost</div>
              </div>
              ...
              <div class="space-y-4 mb-8 text-left">
                <div class="flex items-center gap-3">
                  ...
                  <span class="text-gray-700 dark:text-gray-300">Unlimited Drops</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                  </svg>
                  <span class="text-gray-700 dark:text-gray-300">Unlimited Artists</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                  </svg>
                  <span class="text-gray-700 dark:text-gray-300">Reach 52 Stores</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                  </svg>
                  <span class="text-gray-700 dark:text-gray-300">Reach 195 Countries</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                  </svg>
                  <span class="text-gray-700 dark:text-gray-300">No Payment Needed</span>
                </div>
              </div>

              <app-button variant="primary" size="lg" fullWidth="true" routerLink="/signup">
                Drop Now!
              </app-button>
            </div>
          </app-card>
          ...
          <app-card variant="pricing" class="relative border-primary-500">
            ...
            <div class="text-center">
              ...
              <div class="mb-8">
                <div class="text-6xl font-black text-gray-900 dark:text-gray-100 mb-2">100<span class="text-2xl">%</span></div>
                <div class="text-lg text-gray-600 dark:text-gray-400">Revenue Share</div>
                <div class="text-sm text-gray-500 dark:text-gray-500 mt-1">1€ per Year</div>
              </div>
              ...
              <div class="space-y-4 mb-8 text-left">
                <div class="flex items-center gap-3">
                  ...
                  <span class="text-gray-700 dark:text-gray-300">No Revenue Cut</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                  </svg>
                  <span class="text-gray-700 dark:text-gray-300">Fully Customizable</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                  </svg>
                  <span class="text-gray-700 dark:text-gray-300">Priority Queue</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                ...
                <div class="flex items-center gap-3">
                  ...
                  <span class="text-gray-700 dark:text-gray-300">All Free Features</span>
                </div>
              </div>

              <app-button variant="secondary" size="lg" fullWidth="true" disabled="true">
                Coming Soon
              </app-button>
            </div>
          </app-card>
    ...
    <section class="section-padding bg-gray-50 dark:bg-gray-900">
      <div class="container-max">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <app-card *ngFor="let feature of features" variant="feature" class="text-center">
            <div [class]="'w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 ' + feature.color">
              <div [innerHTML]="feature.icon" class="w-8 h-8 text-white"></div>
            </div>
            <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">{{ feature.title }}</h3>
    ...
    <section class="section-padding">
      <div class="container-max">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <app-card *ngFor="let testimonial of testimonials" variant="testimonial">
            <div class="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p *ngIf="testimonial.role" class="text-sm text-gray-500 dark:text-gray-400">{{ testimonial.role }}</p>
              </div>
            </div>
    ...
    <section class="section-padding bg-gradient-to-r from-primary-600 to-primary-700">
      <div class="container-max text-center">
        ...
        <p class="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
          Join thousands of artists who trust BBN Music to distribute their music worldwide.
        </p>
        <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
          <app-button 
            variant="secondary" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="col-span-1 md:col-span-2">
            ...
            <p class="text-gray-400 leading-relaxed max-w-md">
              ...
              Maximize your reach without limits and let the world hear your music.
            </p>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><a href="#" class="hover:text-white transition-colors duration-200">Artists</a></li>
              <li><a href="#" class="hover:text-white transition-colors duration-200">Stores</a></li>
            </ul>
          </div>
...
export class LandingComponent {
  ...
  testimonials: Testimonial[] = [
    {
      name: 'Redz',
      quote: 'BBN Music has been incredible for getting my tracks out there. The distribution is fast and reaches so many platforms.',
      avatar: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150&h=150&fit=crop&crop=face',
      role: 'Hip-Hop Artist'
    },
    {
      name: 'Criticz',
      quote: 'Love the simplicity and the low cut they take. Finally a platform that cares about artists keeping their earnings.',
