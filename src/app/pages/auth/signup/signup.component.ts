...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center p-4">
      <!-- Background Effects -->
      <div class="absolute inset-0 bg-gradient-to-r from-primary-600/10 to-primary-500/5"></div>
      ...
      <div class="relative z-10 w-full max-w-md">
        ...
        <div class="text-center mb-8">
          <div class="flex items-center justify-center gap-3 mb-6">
            <div class="w-12 h-12 bg-brand-gradient rounded-xl flex items-center justify-center">
          ...
          <form [formGroup]="signupForm" (ngSubmit)="onSubmit()" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <app-button 
                ...
                class="bg-white/10 border-white/20 text-white hover:bg-white/20"
              >
                <svg slot="icon-left" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="text-center mt-6">
          <p class="text-gray-400">
            ...
            <a routerLink="/signin" class="text-primary-400 hover:text-primary-300 font-medium transition-colors duration-200">
              Sign in here
            </a>
          </p>
        </div>
...
export class SignupComponent {
  ...
  getFieldError(fieldName: string): string {
    ...
    if (field?.errors && field.touched) {
      ...
      if (field.errors['invalidPassword']) return 'Password must contain at least one letter and one number';
