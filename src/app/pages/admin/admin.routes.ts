...
export const adminRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'publishing',
        loadComponent: () => import('./publishing/publishing.component').then(m => m.PublishingComponent),
        title: 'Publishing - BBN Music Admin'
      },
      {
        path: 'payouts',
        loadComponent: () => import('./payouts/admin-payouts.component').then(m => m.AdminPayoutsComponent),
      ...
      {
        path: 'takedown',
        loadComponent: () => import('./takedown/takedown.component').then(m => m.TakedownComponent),
