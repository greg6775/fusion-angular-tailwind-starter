...
@Component({
  ...
  template: `
    ...
    >
      <!-- Backdrop -->
      <div class="fixed inset-0 bg-black/50 transition-opacity duration-300"></div>
      ...
      <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        ...
        >
          ...
          <!-- Footer -->
          <div *ngIf="showFooter" class="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700 rounded-b-2xl">
